...
object FunctionalProgramming extends App {
	...
	*/
	...
	//syntax sugars
	val doubler: Int => Int = (x: Int) => 2 * x		//could also leave out Int => Int as compiler will infer
	doubler(4)	//8
	...
	*/
	...
	//equivalent to the map/flatmap chain above on line 71
